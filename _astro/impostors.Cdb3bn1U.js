import{T as A,a as F,L as z,m as B,n as b,D as G,e as _,P as L,I as O,j as h,d as E,V as w,Q as R,M as T,h as U,i as V}from"./stage.By0mGTBi.js";import"./Home.astro_astro_type_script_index_0_lang.BjmKiVo_.js";import"./pointer.EDzLkRsE.js";const W=16,$=4,N=4,I=448/320,P=.7685,j=.105;async function H(M,a,c,t,l,D){if(!a.length)return;const r=await new A().loadAsync(`${M}trees/tree_a${t?"_m":""}.webp`);r.colorSpace=F,r.anisotropy=t?2:8,r.generateMipmaps=!0,r.minFilter=z,r.wrapS=r.wrapT=B;const i=c.fog,s=new b({uniforms:{map:{value:r},uS:{value:l},uGain:{value:1.3},fogColor:{value:i?i.color:new _(0)},fogDensity:{value:i?i.density:0}},side:G,transparent:t,alphaToCoverage:!t,depthWrite:!t,premultipliedAlpha:!1,vertexShader:`
...
//# sourceMappingURL=impostors.Cdb3bn1U.js.map
