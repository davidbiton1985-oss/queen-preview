import{T as A,S as F,L as b,C as z,a as B,D as G,b as _,P as L,I as O,c as u,M as E,V as w,Q as R,d as T,e as U,f as V}from"./stage.BzwasEK9.js";import"./Home.astro_astro_type_script_index_0_lang.CjfZzh0u.js";const W=16,$=4,N=4,I=448/320,P=.7685,q=.105;async function k(M,a,c,t,l,D){if(!a.length)return;const r=await new A().loadAsync(`${M}trees/tree_a${t?"_m":""}.webp`);r.colorSpace=F,r.anisotropy=t?2:8,r.generateMipmaps=!0,r.minFilter=b,r.wrapS=r.wrapT=z;const i=c.fog,s=new B({uniforms:{map:{value:r},uS:{value:l},uGain:{value:1.3},fogColor:{value:i?i.color:new _(0)},fogDensity:{value:i?i.density:0}},side:G,transparent:t,alphaToCoverage:!t,depthWrite:!t,premultipliedAlpha:!1,vertexShader:`
